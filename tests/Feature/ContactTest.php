...
class ContactTest extends TestCase
{
    ...
    /** @test */
    public function only_the_owner_of_the_contact_can_be_patch_the_contact()
    {
    ...
    /** @test */
    public function only_owner_can_delete_contact()
    {
        $contact = factory(Contact::class)->create(['user_id'=>$this->user->api_token]);
        $anotherUser = factory(User::class)->create();
